...
class Ventana(tk.Tk):
    ...
    def interfaz_login(self):
            ...
            lbltitulo = tk.Label(self, text='Inicio de sesión', bg="salmon", font=('Arial', 14, 'bold'))
            lbltitulo.grid(row=0, column=0, columnspan=2, padx=5, pady=10)
        
            # # Etiqueta y campo de entrada para el usuario
            lbl_usuario = tk.Label(self, text="Usuario:", bg="salmon", font=("Helvetica", 12, "bold"))
            ...
            lbl_contraseña = tk.Label(self, text="Contraseña:", bg="salmon", font=("Helvetica", 12, "bold"))
