...
class Ventana(tk.Tk):
    ...
    def interfaz_sistema(self):
        ...
        # Etiquetas y campos de entrada para la gestión de los libros
        self.lbl_codigo = tk.Label(ventana_principal, text="Codigo:", bg="gray64", font=("Helvetica", 10, "bold"))
        self.lbl_codigo.grid(row=0, column=0, padx=5, pady=10)
        self.codigo_entry = tk.Entry(ventana_principal)
        self.codigo_entry.grid(row=0, column=1, padx=5, pady=10, columnspan=2, sticky="ew")
    
        self.lbl_titulo = tk.Label(ventana_principal, text="Titulo:", bg="gray64", font=("Helvetica", 10, "bold"))
        self.lbl_titulo.grid(row=1, column=0, padx=5, pady=10)
        self.titulo_entry = tk.Entry(ventana_principal)
        self.titulo_entry.grid(row=1, column=1, padx=5, pady=10, columnspan=2, sticky="ew")
    
        self.lbl_autor = tk.Label(ventana_principal, text="Autor:", bg="gray64", font=("Helvetica", 10, "bold"))
        self.lbl_autor.grid(row=2, column=0, padx=5, pady=10)
        self.autor_entry = tk.Entry(ventana_principal)
        self.autor_entry.grid(row=2, column=1, padx=5, pady=10, columnspan=2, sticky="ew")
    
        self.lbl_categoria = tk.Label(ventana_principal, text="Categoria:", bg="gray64", font=("Helvetica", 10, "bold"))
        self.lbl_categoria.grid(row=3, column=0, padx=5, pady=10)
    ...
    def buscar(self):
        """
        Realiza una búsqueda según el criterio seleccionado, gestionando la visibilidad de campos.
        """
        criterio = self.opciones_busqueda.get()
        entry = self.ocultar_campos(criterio)  
